...
### 👩‍💻 Quem sou eu
Sou uma estudante de Ciência da Computação apaixonada por tecnologia e organização de processos administrativos. Tenho experiência em rotinas administrativas, atendimento ao público e uso de sistemas digitais, e atualmente busco evoluir na área de TI e gestão de ativos.

### 🛠️ Linguagens e Ferramentas
* **Front-end:** HTML, CSS
* **Back-end:** 
* **Ferramentas:** Git, Trello, SimplesVet, Pacote Office, Google Workspace
* **Outros:** Metodologias Ágeis, Atendimento Digital

### 🚀 Projetos em Destaque
* [Gestão de Cirurgias com Trello](link) - Organização de datas e processos utilizando Trello.
* [Sistema de Atendimento SimplesVet](link) - Experiência prática em gestão de cadastros e cobranças.
